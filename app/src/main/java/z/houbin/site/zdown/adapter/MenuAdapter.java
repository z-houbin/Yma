...
public class MenuAdapter extends BaseAdapter {
    ...
    private String[] menuItems = new String[]{"QQ音乐\n(歌单,专辑,搜索)", "网易云\n(歌单,专辑,搜索)", "酷我", "索尼Hi-Res", "全民K歌", "抖音/Tik Tok (无水印)", "Instagram", "美拍", "秒拍", "快手"};
    private Integer[] menuIcons = new Integer[]{R.drawable.icon_qqmusic, R.drawable.icon_netease, R.drawable.icon_kuwo, R.drawable.icon_sony, R.drawable.icon_qmkg, R.drawable.icon_douyin, R.drawable.icon_instagram, R.drawable.icon_meipai, R.drawable.icon_miaopai, R.drawable.icon_kuaishou};
